...
DCS = {
    ...
    Spot = {
        ...
        getPoint  = function(_spot) -- TODO Need help with this one
            local _status, _ = pcall(function()
            _spot:getPoint();
            end)
            if not _status then
        ...
        setPoint  = function(_spot,_vec3) -- TODO Need help with this one
            local _status, _ = pcall(function()
        ...
        getCode  = function(_spot) -- TODO Need help with this one
            local _status, _ = pcall(function()
            _spot:getCode();
            end)
            if not _status then
        ...
        setCode  = function(_spot,_code) -- TODO Need help with this one
            local _status, _ = pcall(function()
            _spot:setCode(_code);
            end)
            if not _status then
